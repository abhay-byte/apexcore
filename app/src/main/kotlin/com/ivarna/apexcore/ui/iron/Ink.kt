...
fun FigFrame(label: String, modifier: Modifier = Modifier, content: @Composable BoxScope.() -> Unit) {
    Box(modifier) {
        ...
        Text(label, style = IronType.MonoSm, color = ink, modifier = Modifier.padding(6.dp))
        content()
    }
}
        ...
        when (figure) {
            0 -> {
                ...
                repeat(12) { i ->
                    ...
                    drawLine(
                        ink, Offset(center.x + cos(a) * d(66), center.y + sin(a) * d(66)),
                        Offset(center.x + cos(a) * d(74), center.y + sin(a) * d(74)), w
                    )
                }
                drawLine(Iron.Signal700, center, Offset(center.x + d(26), center.y - d(44)), 2.5f * s)
                drawCircle(ink, d(4), center)
                drawText(
                    measurer.measure(
                        "S/N 3F-0042",
                        TextStyle(fontFamily = PlexMono, fontSize = 9.sp, color = ink)
                    ),
            ...
            1 -> {
                ...
                repeat(16) { i ->
                    ...
                    drawLine(
                        ink, Offset(c.x + cos(a) * d(44), c.y + sin(a) * d(44)),
                ...
                drawText(
                    measurer.measure(
                        "+1.4 GB",
                        TextStyle(fontFamily = PlexMono, fontSize = 13.sp, color = Iron.Signal700)
                    ),
            ...
            2 -> {
                ...
                drawText(
                    measurer.measure(
                        "144",
                        TextStyle(fontFamily = PlexMono, fontSize = 17.sp, color = Iron.Phosphor400)
                    ),
                    topLeft = Offset(d(80), d(60))
                )
                drawText(
                    measurer.measure("FPS", TextStyle(fontFamily = PlexMono, fontSize = 7.sp, color = ink)),
            ...
            4 -> {
                ...
                drawText(
                    measurer.measure("or", TextStyle(fontFamily = Caveat, fontSize = 13.sp, color = ink)),
